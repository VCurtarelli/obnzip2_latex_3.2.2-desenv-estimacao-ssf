...
\resumo{Nesse texto, estudaremos diferentes métodos para estimação do campo de velocidade do som 2D na coluna d'água, explorando e adaptando as abordagens disponíveis na literatura. Uma gama de métodos será analisada, desde estabelecer métodos-padrão para técnicas tradicionais até modificar métodos conhecidos do caso 1D para o multi-dimensional. Nós compararemos estes métodos estabelecidos através de simulações, avaliando seus desempenhos em diferentes configurações e situações. Além de um estudo sobre as técnicas, também avaliaremos seus desempenhos (em particular daquelas que independam de informações \textsl{a priori}) em uma vasta gama de configurações de alocação dos dispositivos, buscando avaliar a relação entre as diferentes configurações e as performances alcançadas.}  % Um breve resumo do que o relatório trata
