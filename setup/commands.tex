...
\setlength{\cftchapnumwidth}{2.5em}  % For Chapters (if using report/book)

\DeclareSIUnit{\south}{\ensuremath{\dg}~S}
\DeclareSIUnit{\north}{\ensuremath{\dg}~N}
\DeclareSIUnit{\west}{\ensuremath{\dg}~W}
\DeclareSIUnit{\east}{\ensuremath{\dg}~E}
