...
É possível modificar a formulação da TTT (ou da SVD) alcançada na \cref{sec:modelo-padrão-TTT} para incluir (de alguma forma) a informação de um perfil-referência.
...
\subsubsection*{Modelos TPS}

Além do perfil teórico de Munk, é possível obter um perfil de referência da velocidade utilizando algum dos métodos conhecidos que relacionem temperatura, pressão, e salinidade, com a velocidade. Trabalhos como os \cite{wilson_speed_1959,wilson_equation_1960,delgrosso_new_1974,chen_speed_1977,mackenzie_nineterm_1981,wong_speed_1995,mcdougall_getting_2011} relacionam essas propriedades da água com a velocidade do som, por diversas abordagens para modelagem.

\subsection{Método em camadas separadas}
\label{subsec:sec4:metodo_em_camadas}
...
\label{subsec:sec4:metodo_trade-off}
\newcalbv{I}
...
\label{subsec:sec4:formas_normalizadas}
