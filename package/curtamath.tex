...
\NewDocumentCommand{\trace}{m}{\Trace\pts{#1}}
\NewDocumentCommand{\rank}{m}{\Rank\pts{#1}}
\NewDocumentCommand{\diag}{m}{\Diag\pts{#1}}
\NewDocumentCommand{\nul}{m}{\Null\pts{#1}}
\NewDocumentCommand{\kernel}{m}{\Kern\pts{#1}}

\NewDocumentCommand{\var}{m}{\phi_{#1}}
\NewDocumentCommand{\Corr}{m}{\bv{\Phi}_{#1}}
...
\NewDocumentCommand{\el}{m m}{%
	\bts{#1}_{(#2)}
}

\ProvideDocumentCommand{\Id}{}{\textrm{\textbf{I}}\setboldmathwarning}

% Optimization commandas
\NewDocumentCommand{\opt}{s m}{%
	\IfBooleanTF{#1}{{#2}^{\star}}{#2^{\star}}%
}
\DeclareMathOperator{\obs}{obs}
\DeclareMathOperator{\est}{est}
\DeclareMathOperator{\rfr}{ref}
\DeclareMathOperator*{\argmin}{argmin}
\DeclareMathOperator{\End}{end}
\DeclareMathOperator{\src}{src}
%\newcommand{\argmin}{\Argmin\limits}

\NewDocumentCommand{\pdv}{m O{} m O{}}{\frac{\partial^{#2} #1}{\partial #3^{#4}}}
